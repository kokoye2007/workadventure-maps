...
var defaultAssetsUrl = "https://unpkg.com/@workadventure/scripting-api-extra@1.9.10/dist";
...
// node_modules/@workadventure/scripting-api-extra/dist/Features/workadventure_assets_url.js
var workadventureAssetsHtmlUrl = "https://admin.workadventu.re/html";
...
function initDoorstep(doorstepZone, doorVariable, properties, assetsUrl) {
  ...
  function openKeypad() {
    ...
    if (doorstepZone.type === "tilelayer") {
      ...
      if (doorstepZone.x === void 0 || doorstepZone.y === void 0 || doorstepZone.width === void 0 || doorstepZone.height === void 0) {
...
async function initDoors(assetsUrl) {
  ...
  for (const object of await getAreaObject()) {
    ...
    if (doorVariableName) {
      const doorVariable = variables.get(doorVariableName);
      if (doorVariable === void 0) {
        throw new Error('Cannot find variable "' + doorVariableName + '" referred in the "doorVariable" property of object "' + object.name + '"');
      }
